...
def getweather():
    try:
        ...
        api="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=83c976f17cd4739a715f633046f8cafe"
...
textfield=tk.Entry(root,justify="center",width=17,font=("poppins",23,"bold"),bg="#404040",border=0,fg="white")
...
label1=Label (root,text="Humudity",font=("Helvetica",15,"bold"),fg="white",bg="#1ab5ef")
